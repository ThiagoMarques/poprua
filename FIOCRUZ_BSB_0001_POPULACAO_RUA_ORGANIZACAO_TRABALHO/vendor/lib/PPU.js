...
const arrayModule = [0, 29, 48, 58, 83, 100, 118];
/* Numeração das páginas de exercícios (manter 0)*/
let arrayExercise = [0, 27, 46, 56, 81, 98, 114, 115];
/* Nome dos exercícios */
const arrayScore = ['EX1', 'EX2', 'EX3', 'EX4', 'EX5', 'EX6', 'EX7'];
/* Breadcrumb */

const arrayBreadCrumb1 = [
    'Análise do perfil da população atendida',
    'Demanda espontânea e programada',
    'Identificação de ações prioritárias',
    'A organização da agenda',
    'As ofertas mais efetivas',
    'Monitoramento e avaliação do trabalho'
]
const arrayBreadCrumb2 = [
    'Ferramentas e modos para analisar as especificidades',
    'Modos de organizar as demandas',
    'Estratégias para estratificar os riscos e vulnerabilidades',
    'Modelos de agenda semanal e mensal',
    'Repertório de Boas Práticas em saúde',
    'Como monitorar o trabalho?'
];
// const arrayBreadCrumb1 = [
//     'Análise do perfil da população atendida',
//     'Demanda espontânea e programada',
//     'Identificação de ações prioritárias',
//     'A organização da agenda, para o trabalho com a PSR',
//     'As ofertas mais efetivas para a PSR',
//     'Monitoramento e avaliação do trabalho'
// ]
// const arrayBreadCrumb2 = [
//     'Ferramentas e modos para analisar as especificidades da PSR local',
//     'Modos de organizar as demandas para ter ofertas de demanda espontânea e também de demanda programada/ações programáticas para a PSR',
//     'Estratégias para estratificar os riscos e vulnerabilidades, para elencar as ações prioritárias',
//     'Modelos de agenda semanal e mensal para o trabalho com a PSR',
//     'Repertório de Boas Práticas em saúde com a PSR',
//     'O que e como monitorar o trabalho com a PSR?'
// ];
...
function createStatusDefault(){
    ...
    '112': false, '113': false, '114': false, '115': false, '116': false, '117': false, '118': false};
...
function updateLTI(status){
    ...
    arrayScore.forEach(ex => {
        let score = (checkNote(ex, status) / 7);
        lti += score;
    });
